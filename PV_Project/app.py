...
class CreditMemoGenerator(FPDF):
    ...
    def footer(self):
        # 页脚 + 免责声明 (包含 [改进4] MAS Green 降调)
        self.set_y(-25)
        self.set_font("Arial", 'I', 6) # 字体极小，做免责
    ...
    def draw_conclusion_box(self, text):
        # [改进1] Credit Conclusion Box (一句话总结框)
        self.set_fill_color(245, 245, 245) # 极浅灰
        self.set_draw_color(200, 200, 200) # 边框
        self.set_font("Arial", 'I', 9) # 斜体，像VP手写的
    ...
    def add_version_log(self):
        # [改进5] Version Control / Change Log
        self.ln(10)
        self.set_font("Courier", '', 7) # 代码字体
    ...
    def generate_report(self, data, filename="Credit_Committee_Memo.pdf"):
        ...
        # 表格信息
        self.set_font("Arial", 'B', 10); self.cell(40, line_height, "Borrower:", 0)
        self.set_font("Arial", '', 10);  self.cell(col_width, line_height, data['borrower'], 0)
        self.set_font("Arial", 'B', 10); self.cell(25, line_height, "Facility:", 0)
        self.set_font("Arial", '', 10);  self.cell(col_width, line_height, data['facility'], 0, 1)
        
        self.set_font("Arial", 'B', 10); self.cell(40, line_height, "Guarantor:", 0)
        self.set_font("Arial", '', 10);  self.cell(col_width, line_height, data['guarantor'], 0)
        self.set_font("Arial", 'B', 10); self.cell(25, line_height, "Amount:", 0)
        self.set_font("Arial", '', 10);  self.cell(col_width, line_height, data['amount'], 0, 1)
        self.ln(3)
...
# ==========================================
# 模拟数据输入 (Reflecting Level 3 Feedback)
# ==========================================
if __name__ == "__main__":
    mock_data = {
        "borrower": "Longi Green Energy (Vietnam) Co., Ltd.",
        "guarantor": "Longi Green Energy (SH.601012)",
        ...
        # [改进1] 一句话总结 VP 视角
        "credit_view": "Parent-supported structure mitigates subsidiary liquidity risk. However, high exposure to US trade policy warrants close monitoring of 'Anti-Circumvention' lists.",

        "risk_items": [
            {"dim": "Financials", "status": "Low", "metric": "Score 780 (AA)", "comment": "Strong parent support."},
            {"dim": "Market Risk", "status": "Medium", "metric": "Implied Prem. +150bps", "comment": "Market pricing does not fully reflect current geopolitical risks."}, 
